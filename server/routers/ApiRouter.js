...
class ApiRouter {
  ...
  init() {
    ...
    this.router.get('/v2/libraries/:id/collections', CollectionV2Controller.validateQuery.bind(this), LibraryController.middleware.bind(this), CollectionV2Controller.findAll.bind(this))
