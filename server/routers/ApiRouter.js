...
class ApiRouter {
  ...
  init() {
    ...
    this.router.get('/v2/libraries/:id/collections', CollectionV2Controller.parseQuery.bind(this), LibraryController.middleware.bind(this), CollectionV2Controller.findAll.bind(this))
